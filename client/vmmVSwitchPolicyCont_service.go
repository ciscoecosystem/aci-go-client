...
func (sm *ServiceManager) CreateRelationvmmRsVswitchExporterPol(parentDn, tDn string) error {
	dn := fmt.Sprintf("%s/vswitchpolcont/rsvswitchExporterPol-[%s]", parentDn, tDn)
...
func (sm *ServiceManager) CreateRelationvmmRsVswitchOverrideFwPol(parentDn, tnNwsFwPolName string) error {
	dn := fmt.Sprintf("%s/vswitchpolcont/rsvswitchOverrideFwPol", parentDn)
	containerJSON := []byte(fmt.Sprintf(`{
		"%s": {
			"attributes": {
				"dn": "%s",
...
func (sm *ServiceManager) CreateRelationvmmRsVswitchOverrideStpPol(parentDn, tnStpIfPolName string) error {
	dn := fmt.Sprintf("%s/vswitchpolcont/rsvswitchOverrideStpPol", parentDn)
	containerJSON := []byte(fmt.Sprintf(`{
		"%s": {
			"attributes": {
				"dn": "%s",
...
func (sm *ServiceManager) DeleteRelationvmmRsVswitchOverrideLldpIfPol(parentDn string) error {
	dn := fmt.Sprintf("%s/vswitchpolcont/rsvswitchOverrideLldpIfPol", parentDn)
...
func (sm *ServiceManager) CreateRelationvmmRsVswitchOverrideMcpIfPol(parentDn, tnMcpIfPolName string) error {
	dn := fmt.Sprintf("%s/vswitchpolcont/rsvswitchOverrideMcpIfPol", parentDn)
	containerJSON := []byte(fmt.Sprintf(`{
		"%s": {
			"attributes": {
				"dn": "%s",
...
func (sm *ServiceManager) CreateRelationvmmRsVswitchOverrideCdpIfPol(parentDn, tnCdpIfPolName string) error {
	dn := fmt.Sprintf("%s/vswitchpolcont/rsvswitchOverrideCdpIfPol", parentDn)
	containerJSON := []byte(fmt.Sprintf(`{
		"%s": {
			"attributes": {
				"dn": "%s",
	...
	}`, "vmmRsVswitchOverrideCdpIfPol", dn, tnCdpIfPolName))
...
func (sm *ServiceManager) DeleteRelationvmmRsVswitchOverrideLacpPol(parentDn string) error {
	dn := fmt.Sprintf("%s/vswitchpolcont/rsvswitchOverrideLacpPol", parentDn)
