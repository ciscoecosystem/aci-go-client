...
func (sm *ServiceManager) ReadNodeBlockFW(name string, firmware_group string) (*models.NodeBlock, error) {
...
func (sm *ServiceManager) UpdateNodeBlockFW(name string, firmware_group string, description string, fabricNodeBlkattr models.NodeBlockAttributes) (*models.NodeBlock, error) {
	rn := fmt.Sprintf("nodeblk-%s", name)
	parentDn := fmt.Sprintf("uni/fabric/fwgrp-%s", firmware_group)
	fabricNodeBlk := models.NewNodeBlock(rn, parentDn, description, fabricNodeBlkattr)
...
func (sm *ServiceManager) ListNodeBlockFW(firmware_group string) ([]*models.NodeBlock, error) {
