...
func (sm *ServiceManager) CreateL4L7RedirectHealthGroup(name string, tenant string, description string, nameAlias string, vnsRedirectHealthGroupAttr models.L4_L7RedirectHealthGroupAttributes) (*models.L4_L7RedirectHealthGroup, error) {
...
func (sm *ServiceManager) ReadL4L7RedirectHealthGroup(name string, tenant string) (*models.L4_L7RedirectHealthGroup, error) {
...
func (sm *ServiceManager) UpdateL4L7RedirectHealthGroup(name string, tenant string, description string, nameAlias string, vnsRedirectHealthGroupAttr models.L4_L7RedirectHealthGroupAttributes) (*models.L4_L7RedirectHealthGroup, error) {
	rn := fmt.Sprintf(models.RnvnsRedirectHealthGroup, name)
	parentDn := fmt.Sprintf(models.ParentDnvnsRedirectHealthGroup, tenant)
	vnsRedirectHealthGroup := models.NewL4_L7RedirectHealthGroup(rn, parentDn, description, nameAlias, vnsRedirectHealthGroupAttr)
...
func (sm *ServiceManager) ListL4L7RedirectHealthGroup(tenant string) ([]*models.L4_L7RedirectHealthGroup, error) {
